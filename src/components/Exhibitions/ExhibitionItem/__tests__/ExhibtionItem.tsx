...
import ExhibtionItem from "../ExhibtionItem";
...
const mokeData = {
  ...
  "description": "Please note: this exhibition is open on weekdays only.",
...
describe("ExhibtionItem", () => {
  describe("Snapshot tests", () => {
    test("it matches the snapshot", () => {
      const { container } = render(
        <ExhibtionItem info={mokeData}></ExhibtionItem>
      );
